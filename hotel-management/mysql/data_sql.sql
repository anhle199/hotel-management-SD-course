...
values
(1, 2, 'Mineral Water', 1, 4),
(1, 1, 'Steak Diane', 0, 40),
(1, 1, 'Keychain', 2, 3),
(2, 1, 'Crab Bisque Soup', 0, 12),
(2, 1, 'Escalope of Chicken with Boiled Potato', 0, 16),
(2, 3, 'Sapporo', 1, 10),
(2, 1, 'Shirt', 2, 25),
(3, 1, 'Cocktail', 1, 70),
(3, 1, 'Onion Soup', 0, 12),
(3, 1, 'Grilled Tuna with Lemon Sauce', 0, 18),
(4, 1, 'Umbrella', 2, 13),
(4, 2, 'Caramel Custard', 0, 6),
(4, 2, 'Coke', 1, 5),
(5, 1, 'Coffee Cup', 2, 17),
(5, 2, 'Fountain Pen', 2, 30),
(6, 1, 'Sparkling Water', 1, 8),
(6, 1, 'Ceasar Salad', 0, 15),
(6, 1, 'Lobster Thermidor', 0, 52),
(6, 1, 'Banana Flambees', 0, 14),
(7, 2, 'Jewelry', 2, 1700),
(8, 1, 'Chateaubriand', 0, 42),
(8, 1, 'Champange', 1, 280),
(8, 1, 'Pepsi', 1, 5),
(9, 1, 'Vodka', 1, 140),
(9, 1, 'Cap', 2, 400),
...
values
(1, 30, 'Crab Bisque Soup', 0, 12),
(1, 20, 'Banana Flambees', 0, 14),
(1, 45, 'Pepsi', 1, 5),
(1, 10, 'Umbrella', 2, 13),
(1, 15, 'Fountain Pen', 2, 30),
(2, 20, 'Lobster Thermidor', 0, 52),
(2, 40, 'Steak Diane', 0, 40),
(2, 32, 'Sapporo', 1, 10),
(2, 10, 'Cocktail', 1, 70),
(3, 5, 'Jewelry', 2, 1700),
(3, 35, 'Shirt', 2, 25),
(3, 14, 'Cap', 2, 8),
(3, 20, 'Keychain', 2, 3),
(4, 42, 'Spring Rolls', 0, 10),
(4, 20, 'Grilled Tuna with Lemon Sauce', 0, 18),
(4, 16, 'Chateaubriand', 0, 42),
(4, 15, 'Red Wine', 1, 400);
